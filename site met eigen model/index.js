...
async function detectTFMOBILE(imgToPredict) {
    ...
    renderPredictionBoxes(predictions.dataSync()[4], predictions.dataSync()[1], predictions.dataSync()[2]);
