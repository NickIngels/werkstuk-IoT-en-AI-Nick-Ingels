...
// model_url = 'https://raw.githubusercontent.com/NickIngels/werkstuk-IoT-en-AI-Nick-Ingels/main/model.json';
//Call load function
...
async function detectTFMOBILE(imgToPredict) {
    ...
    var tf4d_ = tf.tensor4d(Array.from(resized.dataSync()), [1, vidHeight, vidWidth, 3]); // was [1, vidHeight, vidWidth, 3]
    ...
    renderPredictionBoxes(predictions[4].dataSync(), predictions[1].dataSync(), predictions[2].dataSync(), predictions[6].dataSync());
...
function renderPredictionBoxes(predictionBoxes, predictionClasses, predictionScores, predictionTest) {
    //console.log('TESTING', predictionTest);
    ...
    for (let i = 0; i < 99; i++) {
        ...
        if (score > 70 && score < 100) {
            ...
            highlighter.style = 'left: ' + minX + 'px; ' +
                ...
                'width: ' + width_ + 'px; ' +
                'height: ' + height_ + 'px;';
            highlighter.innerHTML = '<p>' + Math.round(score) + '% ' + 'Mandarijn: Niet kopen!' + '</p>';
